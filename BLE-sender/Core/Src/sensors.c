...
void getPressure(float *pressure){
	...
	HAL_I2C_Master_Transmit(&hi2c1,addressWrite,pressXL,2,1);
	HAL_I2C_Master_Transmit(&hi2c1,addressRead,data,2,1);
	lsb=data[0];

	HAL_I2C_Master_Transmit(&hi2c1,addressWrite,pressL,2,1);
	HAL_I2C_Master_Transmit(&hi2c1,addressRead,data,2,1);
	lsb|=data[0]<<8;

	HAL_I2C_Master_Transmit(&hi2c1,addressWrite,pressH,2,1);
	HAL_I2C_Master_Transmit(&hi2c1,addressRead,data,2,1);
	lsb|=data[0]<<16;
